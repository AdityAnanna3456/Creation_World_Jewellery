...
<head>
	...
	<title>Creation World Jewellery</title>
...
<body>
	...
	<section class="form">
		...
		<div>
			<form action="userinfo.php" method="post" enctype="multipart/form-data">
				<div>
					<h2>Full Name</h2>
					<input type="text" name="user" autocomplete="off" placeholder="Name">

				</div>
				<div>
					<h2>Email Id</h2>
					<input type="text" name="email" autocomplete="off" placeholder="email" id="emailid">
				...
				<div>
					<h2>Address</h2>
					<input type="text" name="address" autocomplete="off" placeholder="">
				</div>
				<div>
					<h2>Product Code</h2>
	...
	<div class="footer">
		<div class="container">
			...
			<hr>
			<p class="copyright">© 2024 Creation world jewellery. All rights reserved.</p>
		</div>
	</div>
</body>
